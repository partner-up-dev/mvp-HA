...
export const analyticsDailyCommunity = pgTable("analytics_daily_community", {
...
export const insertAnalyticsDailyCommunitySchema = createInsertSchema(
  analyticsDailyCommunity,
);
export const selectAnalyticsDailyCommunitySchema = createSelectSchema(
  analyticsDailyCommunity,
);

export type AnalyticsDailyCommunityRow = typeof analyticsDailyCommunity.$inferSelect;
export type NewAnalyticsDailyCommunityRow =
  typeof analyticsDailyCommunity.$inferInsert;
