<template>
  <div class="stack">
    ...
    <BentoLayout v-else>
      <BentoItem :title="t('adminBookingExecution.pendingTitle')" span="full">
        <div class="stack">
          ...
          <div v-if="filteredPendingItems.length === 0" class="empty-state">
            ...
            >
              <div class="section-header">
                <div class="stack stack--tight">
                  ...
                  <p class="hint">#{{ item.prId }} / {{ item.prType }} / {{ item.status }}</p>
                </div>
              ...
              <div class="meta-grid">
                ...
                <div class="meta-item">
                  ...
                  <strong>{{ item.location ?? t("adminBookingExecution.noneText") }}</strong>
                </div>
                <div class="meta-item">
                  <span class="meta-label">{{
                ...
                <div class="meta-item">
                  ...
                  <strong>{{ formatDateTime(item.effectiveBookingDeadlineAt) }}</strong>
                </div>
                <div class="meta-item">
                  <span class="meta-label">{{
                ...
                <div class="meta-item">
                  ...
                  <strong>{{ formatContactState(item.bookingContact.state) }}</strong>
                </div>
                <div class="meta-item">
                  <span class="meta-label">{{
              ...
              <div v-if="drafts[item.prId]" class="field-grid">
                <label class="field">
              ...
              <div class="stack stack--tight">
                ...
                <p v-if="drafts[item.prId]?.errorMessage" class="field-error">
      ...
      <BentoItem :title="t('adminBookingExecution.auditTitle')" span="full">
        <div class="stack">
          <div class="section-header">
            <p class="hint">
              {{
          ...
          <div v-if="filteredAuditItems.length === 0" class="empty-state">
            ...
            >
              ...
              <div class="meta-grid">
                <div class="meta-item">
                  ...
                  <strong>{{ audit.actorLabel ?? t("adminBookingExecution.noActor") }}</strong>
                </div>
                <div class="meta-item">
                  <span class="meta-label">{{
                ...
                <div class="meta-item">
                  ...
                  <strong>{{ audit.location ?? t("adminBookingExecution.noneText") }}</strong>
                </div>
                <div class="meta-item">
                  <span class="meta-label">{{
                    t("adminBookingExecution.timeLabel")
                ...
                <template v-if="audit.kind === 'BOOKING_EXECUTION'">
                  ...
                  <div class="meta-item field--full">
                    ...
                    <strong>{{ audit.reason ?? t("adminBookingExecution.noReason") }}</strong>
                  </div>
                  <div class="meta-item field--full">
                    <span class="meta-label">{{
                      t("adminBookingExecution.auditNotificationSummaryLabel")
                    }}</span>
                    <strong>{{ formatNotificationSummary(audit.notificationSummary) }}</strong>
                  </div>
                </template>
                ...
                <template v-else>
                  <div class="meta-item">
                    ...
                    <strong>{{ audit.partnerId ?? t("adminBookingExecution.noneText") }}</strong>
                  </div>
                  <div class="meta-item">
                    <span class="meta-label">{{
...
import {
  type AdminSupportResourceExecutionWorkspace,
  useAdminSupportResourceExecution,
} from "@/domains/admin/use-cases/support-resource/useAdminSupportResourceExecution";
...
type Workspace = AdminSupportResourceExecutionWorkspace;
...
const supportResourceExecution = useAdminSupportResourceExecution(isAdmin);
const workspaceQuery = supportResourceExecution.workspaceQuery;
...
const normalizedSearch = computed(() => props.searchText.trim().toLowerCase());
...
watchEffect(() => {
  emit("stats-change", {
    ...
    auditCount: auditItems.value.length,
    filteredPendingCount: filteredPendingItems.value.length,
    filteredAuditCount: filteredAuditItems.value.length,
  });
});
...
const handleSubmit = async (item: PendingItem) => {
  ...
  try {
    await supportResourceExecution.submitExecution({
      prId: item.prId,
      input: {
...
const handleRelease = async (item: PendingItem) => {
  ...
  try {
    await supportResourceExecution.releasePartner({
      prId: item.prId,
