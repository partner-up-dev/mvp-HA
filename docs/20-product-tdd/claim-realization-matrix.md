...
| 搭子请求可传播、可回访 | canonical routes, share/meta endpoints, public config | share UI, route navigation, history lists, page-level re-entry | shared route contract and typed IDs |
